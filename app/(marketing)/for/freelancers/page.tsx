...
const built = buildSimplePage({
  ...
  defaultTitle: "WordPress care plan tools for freelancers — Site Armor",
  defaultDescription:
  ...
  description:
    "Care plans need proof and polish. Site Armor consolidates monitoring, safe updates, backups, and white-label reports so solo WordPress pros can deliver agency-grade retainers.",
  heroDetail:
    "Running care plans as a solo dev means juggling uptime monitors, security scanners, backup services, and spreadsheet reports. Site Armor replaces all of that with a single dashboard that monitors five pillars, automates reports under your brand, and starts at $0 for your first site.",
  stats: [
